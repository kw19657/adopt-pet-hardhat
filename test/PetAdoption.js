...
describe("PetAdoption", function(){
    ...
    describe("Add Pet", function(){
      it("Should revert with the right error in case of using other account", async function(){
    ...
    describe("adopt pet", function(){
      ...
      it("should adopt pet successfully", async function(){
        const { contract, account2, account3 } = await loadFixture(deployContractFixture);
        const firstPetIdx = 1;
